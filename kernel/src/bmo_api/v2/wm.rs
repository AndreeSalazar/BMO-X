...
pub fn start_drag(slot: u32, mx: i32, my: i32) {
    ...
    s.unlock();
    crate::diag::info_u64("bmo_api_v2.wm", "drag start slot=", slot as u64);
    crate::diag::info_u64("bmo_api_v2.wm", "    at mx=", mx as u64);
    crate::diag::info_u64("bmo_api_v2.wm", "    my=", my as u64);
    let _ = (mx, my);
}
...
pub fn enter() -> ! {
    crate::diag::info("bmo_api_v2.wm", "Entering Ring 3 BMO API desktop");
    ...
    loop {
        ...
        if super::input::esc_pressed() {
            crate::diag::info("bmo_api_v2.wm", "ESC pressed — return to welcome");
