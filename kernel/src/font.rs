//! VGA bitmap font — 8x16 CP437 glyphs for framebuffer console.

pub fn get_glyph(ch: u8) -> [u8; 16] {
    if ch == 164 {
        return GLYPH_N_TILDE_LOWER;
    }
    if ch == 165 {
        return GLYPH_N_TILDE_UPPER;
    }
    if ch < 32 || ch > 126 {
...
const GLYPH_N_TILDE_LOWER: [u8; 16] = [
    0x00, 0x00, 0x3C, 0x42, 0x00, 0x3E, 0x63, 0x63,
    0x63, 0x63, 0x63, 0x00, 0x00, 0x00, 0x00, 0x00
];

const GLYPH_N_TILDE_UPPER: [u8; 16] = [
    0x00, 0x3C, 0x42, 0x00, 0x63, 0x67, 0x6F, 0x7B,
    0x73, 0x63, 0x63, 0x00, 0x00, 0x00, 0x00, 0x00
];
