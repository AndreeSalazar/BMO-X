...
///
/// v1.6.9: DESKTOP STUBBED — refined stub screen with:
...
pub fn enter_desktop() {
    ...
    crate::diag::info("welcome", "Run accepted; desktop STUBBED in v1.6.9 (REBOOT to return to welcome)");
    crate::drivers::serial::serial_write("[welcome] Run aceptado: DESKTOP STUBBED v1.6.9. Reboot to recover.\n");
