...
use crate::bmo_core::bmo_abi::type_system::{TypeDescriptor, TypeRegistry};
use crate::bmo_core::bmo_abi::lang_bridge::{LangDescriptor, LangRegistry};
use crate::bmo_core::bmo_abi::exception::UnwindTable;
use crate::bmo_core::bmo_abi::runtime::BmoRuntime;
use super::LoadError;
...
pub fn build_runtime<'a>(
    ...
    let vtables: &[crate::bmo_core::bmo_abi::vtable::BmoVTable<'a>] = &[];
