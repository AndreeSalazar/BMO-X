...
use crate::bmo_core::ui::fb::{colors, Framebuffer};
...
impl Console {
    pub fn new(fb_addr: u64, fb_pitch: u64, fb_stride: u32, fb_width: u32, fb_height: u32) -> Self {
        ...
        let shadow_addr =
            unsafe { crate::memory::page_alloc::alloc_pages_contiguous(shadow_pages).unwrap_or(0) }
                as usize;
        ...
        let history_addr =
            unsafe { crate::memory::page_alloc::alloc_pages_contiguous(history_pages).unwrap_or(0) }
                as usize;
