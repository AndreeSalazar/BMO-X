...
use crate::bmo_core::bmo_abi::interop::win32::ntdll::NtStatus;
...
pub extern "C" fn NtCreateFile(
    ...
    desired_access: u32,
    object_attributes: *const crate::bmo_core::bmo_abi::interop::win32::ntdll::ObjectAttributes,
    io_status_block: *mut crate::bmo_core::bmo_abi::interop::win32::ntdll::IoStatusBlock,
    allocation_size: *const crate::bmo_core::bmo_abi::interop::win32::ntdll::LargeInteger,
    file_attributes: u32,
    share_access: u32,
    ...
    let fd = crate::bmo_core::fs::ramdisk::open(0, 0); // TODO: pass real filename
...
pub extern "C" fn NtReadFile(
    ...
    buffer: bx_u64,
    length: u32,
    byte_offset: *const crate::bmo_core::bmo_abi::interop::win32::ntdll::LargeInteger,
    key: *mut u32,
) -> i32 {
    ...
    let bytes_read = crate::bmo_core::fs::ramdisk::read(file_handle, buffer, length as u64);
...
pub extern "C" fn NtWriteFile(
    ...
    let bytes_written = crate::bmo_core::fs::ramdisk::write(file_handle, buffer, length as u64);
...
pub extern "C" fn NtClose(handle: bx_u64) -> i32 {
    ...
    let result = crate::bmo_core::fs::ramdisk::close(handle);
