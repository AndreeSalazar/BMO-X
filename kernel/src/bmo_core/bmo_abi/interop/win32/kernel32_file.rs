...
pub extern "C" fn CreateFileA(
    ...
    let fd = crate::bmo_core::fs::ramdisk::open(name_bytes.as_ptr() as u64, name_bytes.len() as u64);
...
pub extern "C" fn ReadFile(
    ...
    let result = crate::bmo_core::fs::ramdisk::read(handle, buf, to_read as u64);
...
pub extern "C" fn WriteFile(
    ...
    let result = crate::bmo_core::fs::ramdisk::write(handle, buf, to_write as u64);
...
pub extern "C" fn GetFileSize(handle: bx_u64, high: *mut u32) -> u32 {
    let size = crate::bmo_core::fs::ramdisk::size(handle);
    if size == u64::MAX {
        return !0u32;
    }
    if !high.is_null() {
...
pub extern "C" fn SetFilePointer(handle: bx_u64, distance: i32, high: *mut i32, method: u32) -> u32 {
    ...
    let result = crate::bmo_core::fs::ramdisk::seek(handle, offset, method as u64);
...
pub extern "C" fn SetFilePointerEx(
    ...
    let result = crate::bmo_core::fs::ramdisk::seek(handle, distance as u64, method as u64);
