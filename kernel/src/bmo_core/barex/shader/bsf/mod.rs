...
pub fn load(data: &[u8]) -> Result<BsfShader, BsfError> {
    ...
    let computed = crate::bmo_core::bef::blake3::hash(&spirv_bytes_data[..spirv_bytes_len]);
    if computed != blake3 {
        crate::bmo_core::diag::warn("bsf", "BLAKE3 mismatch — shader payload tampered or wrong hash");
...
/// implementation (spec 20211102) available at `crate::bmo_core::bef::blake3`.
///
...
pub fn compute_hash(words: &[u32]) -> [u8; 32] {
    ...
    crate::bmo_core::bef::blake3::hash(&buf[..len])
}
