//! ÑEXO Codegen — Generación de código vía BMO assembly syntax (legacy) (v0.4.0).
//!
//! El codegen de ÑEXO produce AST de BMO assembly syntax (legacy) como IR intermedio.
//! Luego el traductor de BMO assembly syntax (legacy) lo compila a código nativo.
...
/// Code generator: ÑEXO AST → BMO assembly syntax (legacy) AST.
pub struct Codegen {
