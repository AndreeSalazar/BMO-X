...
use crate::bmo_core::lang::bmo::runtime::io::Graphics;
...
pub fn screen_width() -> usize { unsafe { crate::boot::info::FB_WIDTH as usize } }
pub fn screen_height() -> usize { unsafe { crate::boot::info::FB_HEIGHT as usize } }
