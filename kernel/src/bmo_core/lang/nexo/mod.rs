...
pub fn compile(source: &[u8]) -> BxResult<alloc::vec::Vec<u8>> {
    ...
    let mut traductor = crate::bmo_core::lang::bmoasm::traductor::Traductor::new();
...
#[deprecated(since = "0.9.0", note = "Use crate::bmo_core::lang::nexo::plugins::languages::c::translator::compile_c_to_native instead")]
pub fn compile_c(source: &[u8]) -> BxResult<alloc::vec::Vec<u8>> {
    crate::bmo_core::lang::nexo::plugins::languages::c::translator::compile_c_to_native(source)
}
...
#[cfg(test)]
pub fn serialize_bmoasm_for_test(ast: &crate::bmo_core::lang::bmoasm::parser::ast::Ast) -> alloc::string::String {
...
#[cfg(test)]
fn serialize_stmt(stmt: &crate::bmo_core::lang::bmoasm::parser::ast::Stmt, out: &mut alloc::string::String) {
    use crate::bmo_core::lang::bmoasm::parser::ast::{Stmt as S, Type as T};
    match stmt {
        ...
        S::TypeDecl { name, kind, fields } => {
            ...
            out.push_str(" = ");
            match kind {
                crate::bmo_core::lang::bmoasm::parser::ast::TypeDeclKind::Struct => out.push_str("estructura"),
                crate::bmo_core::lang::bmoasm::parser::ast::TypeDeclKind::Enum => out.push_str("enumero"),
            }
            out.push_str(" { ");
...
#[cfg(test)]
fn serialize_expr(expr: &crate::bmo_core::lang::bmoasm::parser::ast::Expr, out: &mut alloc::string::String) {
    use crate::bmo_core::lang::bmoasm::parser::ast::{Expr as E, BinOp as B};
    match expr {
...
#[cfg(test)]
fn serialize_type(ty: crate::bmo_core::lang::bmoasm::parser::ast::Type) -> &'static str {
    use crate::bmo_core::lang::bmoasm::parser::ast::Type as T;
    match ty {
        T::Num => "num",
        T::Byte => "byte",
        T::Ptr => "ptr",
