...
pub fn nexo_test_compile() {
    crate::cabina::info("bmo", "Language toolchain removed from Ring 0; use offline BEF build");
    crate::dev::console::serial_write(
        "[bmo] Ring 0 no compila lenguajes; carga BEF generado offline.\n",
    );
    crate::cabina::info_u64("bmo", "Generated bytes", 0);
}
