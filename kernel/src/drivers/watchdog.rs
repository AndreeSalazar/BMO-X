...
pub fn arm() {
    ...
    crate::drivers::serial::serial_write("[watchdog] ARMED (5 sec timeout)\n");
}

/// Disarm the watchdog.
pub fn disarm() {
    ARMED.store(0, Ordering::Relaxed);
    crate::drivers::serial::serial_write("[watchdog] DISARMED\n");
}
...
pub fn check() {
    ...
    let tsc_now = crate::arch::cpu::rdtsc();
    let tsc_per_sec = crate::arch::cpu::tsc_per_sec();
