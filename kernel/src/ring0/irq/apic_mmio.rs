...
pub unsafe fn map_apic_mmio() -> Result<u64, &'static str> {
    ...
    if phys_base < 0x1_0000_0000 {
        ...
        crate::dev::console::serial_write("[apic_mmio] using identity mapping at 0x");
        crate::dev::console::serial_write_u64(phys_base, 16);
    ...
    crate::dev::console::serial_write("[apic_mmio] APIC version: 0x");
...
pub fn init() -> Result<(), &'static str> {
    ...
    if !is_apic_enabled() {
        crate::dev::console::serial_write("[apic_mmio] APIC not enabled, enabling...\n");
        enable_apic_global()?;
    }
    ...
    crate::dev::console::serial_write("[apic_mmio] APIC MMIO initialized successfully\n");
    Ok(())
}
