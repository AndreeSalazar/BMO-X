...
use crate::sched::thread::SavedRegs;
...
/// Save the full register context from the kernel stack into a `SavedRegs`.
///
...
pub unsafe extern "C" fn save_context_from_stack(saved_state: *mut u64) -> bool {
    ...
    let regs = &mut *crate::sched::thread::current_thread_ptr();
