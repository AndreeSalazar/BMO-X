...
/// ```
pub fn init() -> CpuInfo {
    crate::drivers::serial::serial_write("[cpu] === Modular CPU Init ===\n");
    ...
    crate::drivers::serial::serial_write("[cpu] FPU initialized\n");
    ...
    crate::drivers::serial::serial_write("[cpu] Lazy FPU switching enabled\n");
    ...
    crate::drivers::serial::serial_write("[cpu] === Init Complete ===\n");
