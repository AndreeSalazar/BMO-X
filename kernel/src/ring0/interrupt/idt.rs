...
extern "C" fn apic_timer_full_handler(saved_state: *mut u64) -> u64 {
    ...
    unsafe {
        crate::interrupt::context::save_context_from_stack(saved_state);
    }
    ...
    if new_idx != cur_idx && new_idx < crate::sched::thread::MAX_THREADS {
        ...
        unsafe {
            let new_rsp = crate::interrupt::context::build_context_on_stack(regs_ptr, kernel_stack_top);
            crate::interrupt::apic::apic_eoi();
            new_rsp
        }
    } else {
...
unsafe fn early_boot_fault_display(vector: u64, error: u64, cr2: u64) -> ! {
    ...
    crate::device::serial::serial_write_u64(vector, 0);
    crate::device::serial::serial_write(" err=0x");
    crate::device::serial::serial_write_u64(error, 16);
    crate::device::serial::serial_write(" cr2=0x");
    crate::device::serial::serial_write_u64(cr2, 16);
    crate::device::serial::serial_write(" rip=0x");
    crate::device::serial::serial_write_u64(rip, 16);
    crate::device::serial::serial_write(" rsp=0x");
    crate::device::serial::serial_write_u64(rsp, 16);
    crate::device::serial::serial_write(" fb=0x");
    crate::device::serial::serial_write_u64(fb_addr, 16);
    crate::device::serial::serial_write("\n");
...
extern "C" fn exception_kill_handler_rust(vector: u64, error: u64, cr2: u64) -> ! {
    ...
    match vector {
        14 => {
            ...
            unsafe {
                crate::device::serial::serial_write("[#PF] CR2=0x");
                crate::device::serial::serial_write_u64(cr2, 16);
                crate::device::serial::serial_write(" ERR=0x");
                crate::device::serial::serial_write_u64(error, 4);
                crate::device::serial::serial_write(" RIP=0x");
                crate::device::serial::serial_write_u64(rip, 16);
                crate::device::serial::serial_write("\n");
            }
            ...
            if let Some(thr) = crate::sched::thread::current_thread() {
                if let Some(proc) = crate::sched::process::get_process(thr.pid) {
                    ...
                    let resolved = unsafe {
                        crate::memory::paging::handle_page_fault(
                            cr2,
                            error,
...
extern "C" fn page_fault_handler_rust(_vector: u64, error: u64, cr2: u64) -> bool {
    ...
    // Try to resolve
    unsafe {
        crate::memory::paging::handle_page_fault(cr2, error, pml4_phys, vmas)
    }
}
