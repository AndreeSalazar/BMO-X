...
/// Segment selectors matching `crate::interrupt::gdt`.
...
pub fn init_syscall() {
    unsafe {
        ...
        let stack_top = crate::interrupt::gdt::kernel_stack_top();
    ...
    unsafe {
        ...
        let result = match nr {
            ...
            n if (0x100..=0x1FF).contains(&(n as u16)) => {
                ...
                crate::bmo_core::bmo_api::dispatch_syscall(n as u16, a0, a1, a2, a3, a4, _a5)
            }
            ...
            // v1.7.4: Security syscalls (0xA0..0xA4) eliminados.
            // ByteDefender y Restaurer se removieron del kernel por
            // ser deferred. Si en el futuro se re-introducen, los
            // syscalls deben volver a este punto.
