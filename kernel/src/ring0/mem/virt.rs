...
pub unsafe fn create_kernel_page_table() -> Option<u64> {
    ...
    crate::dev::console::serial_write("[paging] create_kernel_page_table: STUBBED (use UEFI PML4)\n");
    None
}
...
fn print_hex_debug(val: u64) {
    ...
    crate::dev::console::serial_write(unsafe {
...
unsafe fn alloc_page_table() -> Option<u64> {
    ...
    crate::dev::console::serial_write(" null=");
    crate::dev::console::serial_write(if raw.is_null() { "yes" } else { "no" });
    ...
    crate::dev::console::serial_write("[alloc_pt] aligned=0x");
    print_alloc_hex(aligned_addr as u64);
    crate::dev::console::serial_write(" pad=");
    crate::dev::console::serial_write(if aligned_addr - raw_addr >= 8 { "ok" } else { "no" });
    crate::dev::console::serial_write("\n");
    ...
    crate::dev::console::serial_write("[alloc_pt] about to write_bytes(aligned, 0, 4096)\n");
    core::ptr::write_bytes(aligned, 0, 4096);
    crate::dev::console::serial_write("[alloc_pt] write_bytes OK\n");
    Some(aligned as u64)
}
