//! CP437/VGA 8×16 bitmap font for framebuffer text rendering.
//!
//! Each glyph is 8 pixels wide, 16 pixels tall. Each row is one byte;
//! bit 7 (0x80) = leftmost pixel, bit 0 (0x01) = rightmost pixel.
//!
//! Covers full CP437 character set (0-255) based on the standard IBM
//! VGA 8x16 font (public domain).
//!
//! Spanish keyboard support: Ñ(165)/ñ(164), á(160)/Á(181), é(130)/É(144),
//! í(161)/Í(173), ó(162)/Ó(169), ú(163)/Ú(185), ü(129)/Ü(154),
//! ¡(173)/¿(168), º(167)/ª(166), and full box-drawing/symbols.

/// Returns the 16-byte glyph bitmap for a CP437 character code.
/// Full range: 0..=255. Out-of-range returns blank.
...
static GLYPHS: [[u8; 16]; 256] = [
    // ── CP437 Characters 0-31: control chars (rendered as blank) ────
    ...
    // ── CP437 Characters 32-126: ASCII printable (standard VGA bitmaps) ────
    ...
    [0x00,0x00,0x00,0x6C,0x6C,0xFE,0x6C,0x6C,0xFE,0x6C,0x6C,0x00,0x00,0x00,0x00,0x00], // 35 '#'
    ...
    [0x00,0x00,0xC6,0xC6,0xC6,0x6C,0x38,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00], // 89 'Y'
    ...
    // ── CP437 Characters 128-255: Extended (Latin-1, symbols, box drawing) ────
    // 128 Ç
    [0x00,0x00,0x7C,0xC6,0xC6,0xC0,0xC0,0xC0,0xC0,0xC0,0xC6,0x7C,0x18,0x18,0x0C,0x00],
    // 129 ü
    [0x00,0x00,0x00,0xCC,0xCC,0x00,0x00,0xCC,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 130 é
    [0x00,0x00,0x00,0x00,0x00,0x7C,0xC6,0xC0,0xC0,0xC0,0xC6,0x7C,0x18,0x18,0x0C,0x00],
    // 131 â
    [0x00,0x00,0x00,0x00,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 132 ä
    [0x00,0x00,0xCC,0xCC,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 133 à
    [0x00,0x18,0x30,0x00,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 134 å
    [0x00,0x00,0x18,0x18,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 135 ç
    [0x00,0x00,0x00,0x00,0x00,0x7C,0xC6,0xC0,0xC0,0xC0,0xC6,0x7C,0x18,0x18,0x0C,0x00],
    // 136 ê
    ...
    // 139 ï
    [0x00,0x00,0xCC,0xCC,0x00,0x38,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00],
    // 140 î
    [0x00,0x00,0x18,0x30,0x00,0x38,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00],
    // 141 ì
    [0x00,0x00,0x18,0x30,0x00,0x38,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00],
    // 142 Ä
    [0x00,0x00,0xCC,0xCC,0x00,0x10,0x38,0x6C,0xC6,0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00],
    // 143 Å
    [0x00,0x00,0x18,0x18,0x00,0x10,0x38,0x6C,0xC6,0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00],
    // 144 É
    [0x00,0x00,0x00,0x00,0x00,0xFE,0x66,0x62,0x68,0x78,0x68,0x62,0x66,0xFE,0x00,0x00],
    // 145 æ
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x7E,0xDB,0xDB,0x7E,0x00,0x00,0x00,0x00,0x00],
    // 146 Æ
    [0x00,0x00,0x00,0x00,0xC6,0xC6,0xC6,0xC6,0xFE,0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00],
    // 147 ô
    [0x00,0x00,0x38,0x6C,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 148 ö
    [0x00,0x00,0xCC,0xCC,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 149 ò
    [0x00,0x18,0x30,0x00,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 150 û
    [0x00,0x00,0x38,0x6C,0x00,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 151 ù
    [0x00,0x18,0x30,0x00,0x00,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 152 ÿ
    [0x00,0x00,0xCC,0xCC,0x00,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0x7E,0x06,0x0C,0xF8,0x00],
    // 153 Ö
    [0x00,0x00,0xCC,0xCC,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 154 Ü
    [0x00,0x00,0xCC,0xCC,0x00,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 155 ¢
    [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x7E,0xC0,0xC0,0xC0,0x7E,0x18,0x18,0x00,0x00],
    // 156 £
    [0x00,0x00,0x00,0x00,0x10,0x38,0x60,0x60,0xF8,0x60,0x60,0xF8,0x00,0x00,0x00,0x00],
    // 157 ¥
    [0x00,0x00,0x00,0x00,0x00,0xC6,0x6C,0x38,0xFE,0x38,0x6C,0xC6,0x00,0x00,0x00,0x00],
    // 158 ₧ (peseta sign)
    [0x00,0x00,0x00,0x00,0x00,0x7C,0xC6,0xC0,0xC0,0xC0,0xC6,0x7C,0x18,0x18,0x0C,0x00],
    // 159 ƒ
    [0x00,0x00,0x0C,0x18,0x18,0x3C,0x18,0x18,0x18,0x18,0x18,0x18,0x3C,0x18,0x18,0x00],
    // 160 á  ★ SPANISH
    [0x00,0x00,0x00,0x10,0x38,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 161 í  ★ SPANISH
    [0x00,0x00,0x30,0x18,0x00,0x30,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00],
    // 162 ó  ★ SPANISH
    [0x00,0x00,0x00,0x10,0x38,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 163 ú  ★ SPANISH
    [0x00,0x00,0x00,0x10,0x38,0x00,0xCC,0xCC,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 164 ñ  ★ SPANISH
    [0x00,0x00,0x00,0x00,0x00,0xDC,0x76,0x66,0x66,0x66,0x66,0x66,0x00,0x00,0x00,0x00],
    // 165 Ñ  ★ SPANISH
    [0x00,0x00,0x00,0x00,0x00,0xC6,0xE6,0xF6,0xFE,0xDE,0xCE,0xC6,0x00,0x00,0x00,0x00],
    // 166 ª  ★ SPANISH
    [0x00,0x00,0x00,0x00,0x00,0x00,0x7C,0xC6,0xC0,0xC0,0x7C,0x18,0x18,0x0C,0x00,0x00],
    // 167 º  ★ SPANISH
    ...
    // 169 ⌐
    [0x00,0x00,0x00,0x00,0xC0,0xC0,0xC0,0xFC,0xC0,0xC0,0xC0,0x00,0x00,0x00,0x00,0x00],
    // 170 ¬
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFC,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00],
    // 171 ½
    [0x00,0x00,0x00,0x0C,0x0C,0x06,0x06,0x03,0x83,0xC1,0x60,0x30,0x18,0x18,0x0C,0x00],
    // 172 ¼
    [0x00,0x00,0x00,0x0C,0x0C,0x06,0x06,0x03,0x83,0xC1,0x60,0x30,0x18,0x18,0x0C,0x00],
    // 173 ¡  ★ SPANISH
    [0x00,0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x00,0x00],
    // 174 «
    [0x00,0x00,0x00,0x00,0x00,0x66,0x36,0x1B,0x1B,0x36,0x66,0x00,0x00,0x00,0x00,0x00],
    // 175 »
    [0x00,0x00,0x00,0x00,0x00,0x66,0x6C,0xD8,0xD8,0x6C,0x66,0x00,0x00,0x00,0x00,0x00],
    // 176 ░
    [0xAA,0x55,0xAA,0x55,0xAA,0x55,0xAA,0x55,0xAA,0x55,0xAA,0x55,0xAA,0x55,0xAA,0x55],
    // 177 ▒
    [0xDB,0x92,0x24,0x49,0x92,0x24,0x49,0x92,0x24,0x49,0x92,0x24,0x49,0x92,0x24,0x49],
    // 178 ▓
    [0xDB,0xDB,0x49,0x49,0xDB,0xDB,0x92,0x92,0xDB,0xDB,0x49,0x49,0xDB,0xDB,0x92,0x92],
    // 179 │
    [0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18],
    // 180 ┤
    [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x1B,0x1B,0x18,0x18,0x00,0x00,0x00,0x00,0x00],
    // 181 Á  ★ SPANISH
    [0x00,0x00,0x10,0x38,0x6C,0x00,0x10,0x38,0x6C,0xC6,0xC6,0xFE,0xC6,0xC6,0x00,0x00],
    // 182 ╣
    [0x00,0x00,0x00,0x00,0x00,0xD8,0xD8,0xDB,0xDB,0xD8,0xD8,0x00,0x00,0x00,0x00,0x00],
    // 183 ╗
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1B,0x1B,0x18,0x18,0x00,0x00,0x00,0x00,0x00],
    // 184 ╕
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xD8,0xD8,0x18,0x18,0x00,0x00,0x00,0x00,0x00],
    // 185 Ú  ★ SPANISH
    [0x00,0x00,0x00,0x10,0x38,0x00,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00],
    // 186 ║
    [0x18,0x18,0x18,0x18,0x18,0x1B,0x1B,0x00,0x00,0x1B,0x1B,0x18,0x18,0x18,0x18,0x18],
    // 187 ╗
    [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x1B,0x1B,0x1B,0x1B,0x18,0x18,0x18,0x00,0x00],
    // 188 ╝
    [0x00,0x00,0x00,0x00,0x00,0xD8,0xD8,0xDB,0xDB,0xDB,0xDB,0xD8,0xD8,0xD8,0x00,0x00],
    // 189 ╓
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xDB,0xDB,0xDB,0xDB,0x18,0x18,0x18,0x00,0x00],
    // 190 ╔
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1B,0x1B,0x1B,0x1B,0xD8,0xD8,0xD8,0x00,0x00],
    // 191 ╔
    [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x1B,0x1B,0x1B,0x1B,0x00,0x00,0x00,0x00,0x00],
    // 192 ╚
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1B,0x1B,0x1B,0x1B,0x18,0x18,0x18,0x00,0x00],
    // 193 ╣
    [0x00,0x00,0x00,0x00,0x00,0xD8,0xD8,0xD8,0xD8,0xD8,0xD8,0x00,0x00,0x00,0x00,0x00],
    // 194 ╦
    [0x00,0x00,0x00,0x00,0x00,0xD8,0xD8,0xDB,0xDB,0xDB,0xDB,0xD8,0xD8,0xD8,0x00,0x00],
    // 195 ╠
    [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x1B,0x1B,0x1B,0x1B,0x18,0x18,0x18,0x00,0x00],
    ...
    // 197 ╬
    [0x18,0x18,0x18,0x18,0x18,0x1B,0x1B,0xFF,0xFF,0x1B,0x1B,0x18,0x18,0x18,0x18,0x18],
    // 198 ╞
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xDB,0xDB,0x00,0x00,0x00,0x00,0x00,0x00,0x00],
    // 199 Ç  ★ SPANISH (uppercase)
    [0x00,0x00,0x7C,0xC6,0xC6,0xC0,0xC0,0xC0,0xC0,0xC0,0xC6,0x7C,0x18,0x18,0x0C,0x00],
    // 200 ╚
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xD8,0xD8,0xD8,0xD8,0xD8,0xD8,0xD8],
    // 201 ╔
    [0x00,0x00,0x00,0x00,0x00,0xD8,0xD8,0xDB,0xDB,0xDB,0xDB,0xFF,0xFF,0x00,0x00,0x00],
    // 202 ╩
    [0x00,0x00,0x00,0x00,0x00,0xD8,0xD8,0xD8,0xD8,0xD8,0xD8,0xFF,0xFF,0x00,0x00,0x00],
    // 203 ╦
    [0x00,0x00,0x00,0x00,0x00,0x1B,0x1B,0x1B,0x1B,0x1B,0x1B,0xFF,0xFF,0x00,0x00,0x00],
    // 204 ╠
    [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x1B,0x1B,0x1B,0x1B,0x18,0x18,0x18,0x00,0x00],
    // 205 ═
    [0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0x00,0x00,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00],
    // 206 ╬
    [0x18,0x18,0x18,0x18,0x18,0xDB,0xDB,0xFF,0xFF,0xDB,0xDB,0x18,0x18,0x18,0x18,0x18],
    // 207 ╧
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0x1B,0x1B,0x00,0x00,0x00,0x00,0x00],
    // 208 ╨
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xD8,0xD8,0x00,0x00,0x00,0x00,0x00],
    // 209 ╤
    [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x1B,0x1B,0x18,0x18,0x00,0x00,0x00,0x00,0x00],
    // 210 ╥
    [0x00,0x00,0x00,0x00,0x00,0xD8,0xD8,0xDB,0xDB,0xD8,0xD8,0x00,0x00,0x00,0x00,0x00],
    // 211 ╙
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xDB,0xDB,0x18,0x18,0x00,0x00,0x00,0x00,0x00],
    // 212 ╘
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1B,0x1B,0xD8,0xD8,0x00,0x00,0x00,0x00,0x00],
    // 213 ╒
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0x18,0x18,0x00,0x00,0x00,0x00,0x00],
    // 214 ╓
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xD8,0xD8,0x00,0x00,0x00,0x00,0x00],
    // 215 ╫
    ...
    // 217 ╝
    [0x00,0x00,0x00,0x00,0x00,0xD8,0xD8,0xD8,0xD8,0xD8,0xD8,0xDB,0xDB,0x00,0x00,0x00],
    // 218 ╗
    [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x18,0x18,0x18,0x18,0x1B,0x1B,0x00,0x00,0x00],
    // 219 █
    ...
    // 224 À
    [0x00,0x18,0x30,0x00,0x00,0x10,0x38,0x6C,0xC6,0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00],
    // 225 á  (duplicate of 160, standard CP437)
    [0x00,0x00,0x00,0x10,0x38,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 226 â
    [0x00,0x00,0x38,0x6C,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 227 ã
    [0x00,0x00,0x00,0x00,0x00,0x76,0xDC,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0x76,0x00,0x00],
    // 228 ä
    [0x00,0x00,0xCC,0xCC,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 229 å
    [0x00,0x00,0x18,0x18,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    ...
    [0x00,0x00,0xCC,0xCC,0x00,0x38,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00],
    // 240 ð
    [0x00,0x00,0x00,0x00,0x38,0x6C,0x6C,0x6C,0x6C,0x38,0x7C,0x00,0x00,0x00,0x00,0x00],
    // 241 ñ  (duplicate of 164)
    [0x00,0x00,0x00,0x00,0x00,0xDC,0x76,0x66,0x66,0x66,0x66,0x66,0x00,0x00,0x00,0x00],
    // 242 ò
    [0x00,0x18,0x30,0x00,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 243 ó  (duplicate of 162)
    [0x00,0x00,0x00,0x10,0x38,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 244 ô
    [0x00,0x00,0x38,0x6C,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 245 õ
    [0x00,0x00,0x00,0x00,0x00,0x76,0xDC,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00],
    // 246 ö
    [0x00,0x00,0xCC,0xCC,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 247 ÷
    [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x7E,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00],
    // 248 ø
    [0x00,0x00,0x00,0x00,0x00,0x7C,0xC6,0xDE,0xDE,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00],
    // 249 ù
    [0x00,0x18,0x30,0x00,0x00,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 250 ú  (duplicate of 163)
    [0x00,0x00,0x00,0x10,0x38,0x00,0xCC,0xCC,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 251 û
    [0x00,0x00,0x38,0x6C,0x00,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00],
    // 252 ü
