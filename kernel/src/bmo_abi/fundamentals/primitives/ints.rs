//! Tipos enteros canónicos del BMO ABI. Reemplaza `<stdint.h>` y `<stddef.h>`.
//!
//! Garantizado en todas las plataformas FastOS (x86-64): tamaños fijos,
...
// ─── Tamaños/punteros ─────────────────────────────────────────────────
//   En x86-64 ambos son 64-bit. Si algún día se porta a otra arch, este
...
// ─── Tipos especializados (semánticos) ────────────────────────────────
...
pub type bx_tid = u32;
/// Identificador de CPU lógica (0..=11 en el 5600X con SMT).
pub type bx_cpu_id = u8;

// ─── Constantes de límites (sustituye limits.h) ───────────────────────
