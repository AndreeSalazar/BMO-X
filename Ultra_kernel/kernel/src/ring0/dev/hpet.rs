...
pub fn init() {
    ...
    if mmio_base == 0 {
        crate::ring0::dev::console::serial_write("[hpet] no MMIO base configured\n");
        return;
    }
    init_at(mmio_base);
}
...
pub fn init_at(mmio_base: u64) {
    unsafe {
        ...
        crate::ring0::dev::console::serial_write("[hpet] initialized: freq=");
        crate::ring0::dev::console::serial_write_u64(frequency_hz / 1000, 10);
        crate::ring0::dev::console::serial_write(" kHz, comparators=");
        crate::ring0::dev::console::serial_write_u64(comparator_count as u64, 10);
