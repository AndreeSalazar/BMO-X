...
pub fn init(tsc_freq: u64, hpet_period_fs: u64) {
    ...
    crate::ring0::dev::console::serial_write("[timestamp] TSC=");
    crate::ring0::dev::console::serial_write_u64(tsc_freq / 1_000_000, 10);
    crate::ring0::dev::console::serial_write(" MHz, HPET period=");
    crate::ring0::dev::console::serial_write_u64(hpet_period_fs, 10);
    crate::ring0::dev::console::serial_write(" fs\n");
}
...
pub fn now_ns() -> u64 {
    if super::hpet::is_available() {
        ...
        tsc_to_ns(crate::ring0::cpu::rdtsc())
    }
}
...
pub fn calibrate_tsc_hpet() -> u64 {
    ...
    let tsc_start = crate::ring0::cpu::rdtsc();
    ...
    let tsc_end = crate::ring0::cpu::rdtsc();
