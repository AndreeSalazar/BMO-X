...
//! Context switching for BMO — saves/restores full register state across threads.
//!
...
use crate::ring0::proc::task::SavedRegs;
...
pub unsafe extern "C" fn save_context_from_stack(saved_state: *mut u64) -> bool {
    ...
    let regs = &mut *crate::ring0::proc::task::current_ptr();
