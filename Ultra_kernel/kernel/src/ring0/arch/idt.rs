...
unsafe fn early_boot_fault_display(vector: u64, error: u64, cr2: u64, rip: u64, rsp: u64) -> ! {
    ...
    crate::ring0::dev::console::serial_write("    Vector: ");
    crate::ring0::dev::console::serial_write_u64(vector, 10);
    crate::ring0::dev::console::serial_write(" (fault RIP=");
    crate::ring0::dev::console::serial_write_u64(rip, 16);
    crate::ring0::dev::console::serial_write(", fault RSP=");
    crate::ring0::dev::console::serial_write_u64(rsp, 16);
    crate::ring0::dev::console::serial_write(")\n");
    crate::ring0::dev::console::serial_write("    Error:  0x");
    crate::ring0::dev::console::serial_write_u64(error, 16);
    crate::ring0::dev::console::serial_write("\n");
    if vector == 14 {
        crate::ring0::dev::console::serial_write("    CR2:    0x");
        crate::ring0::dev::console::serial_write_u64(cr2, 16);
        crate::ring0::dev::console::serial_write("\n");
    }
...
extern "C" fn exception_kill_handler_rust(vector: u64, error: u64, cr2: u64, rip: u64, rsp: u64) -> ! {
    ...
    if crate::ring0::proc::task::current().is_none() {
    ...
    unsafe {
        crate::ring0::dev::console::serial_write("[EXC] vec=0x");
        crate::ring0::dev::console::serial_write_u64(vector, 2);
        crate::ring0::dev::console::serial_write(" ERR=0x");
        crate::ring0::dev::console::serial_write_u64(error, 4);
        crate::ring0::dev::console::serial_write(" RIP=0x");
        crate::ring0::dev::console::serial_write_u64(rip, 16);
        crate::ring0::dev::console::serial_write(" CR2=0x");
        crate::ring0::dev::console::serial_write_u64(cr2, 16);
        crate::ring0::dev::console::serial_write("\n");
...
extern "C" fn page_fault_handler_rust(_vector: u64, error: u64, cr2: u64) -> bool {
    ...
    let (pml4_phys, vma_count, vmas_ptr) = if let Some(thr) = crate::ring0::proc::task::current() {
        if let Some(proc) = crate::ring0::proc::process::get_process(thr.pid) {
    ...
    // Try to resolve
    unsafe {
        crate::ring0::mm::virt::handle_page_fault(cr2, error, pml4_phys, vmas)
    }
}
