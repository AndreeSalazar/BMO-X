...
/// Update TSS.rsp0 — called on every ctx switch to set the kernel stack
...
pub fn init_gdt() {
    ...
    crate::ring0::dev::console::serial_write("[gdt] GDT loaded: ");
    crate::ring0::dev::console::serial_write_u64(core::mem::size_of::<Gdt>() as u64, 10);
    crate::ring0::dev::console::serial_write(" bytes, KERNEL_CS=0x");
    crate::ring0::dev::console::serial_write_u64(KERNEL_CS as u64, 16);
    crate::ring0::dev::console::serial_write(" USER_CS=0x");
    crate::ring0::dev::console::serial_write_u64(USER_CS as u64, 16);
    crate::ring0::dev::console::serial_write(" TSS=0x");
    crate::ring0::dev::console::serial_write_u64(TSS_SEL as u64, 16);
    crate::ring0::dev::console::serial_write("\n");
    crate::ring0::dev::console::serial_write("[gdt] IST1=0x");
    crate::ring0::dev::console::serial_write_u64(unsafe { TSS.ist[0] }, 16);
    crate::ring0::dev::console::serial_write(" IST3=0x");
    crate::ring0::dev::console::serial_write_u64(unsafe { TSS.ist[2] }, 16);
    crate::ring0::dev::console::serial_write(" RSP0=0x");
    crate::ring0::dev::console::serial_write_u64(unsafe { TSS.rsp[0] }, 16);
    crate::ring0::dev::console::serial_write("\n");
}
