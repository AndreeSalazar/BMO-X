...
use crate::bmo_abi::primitives::{bx_u32, bx_u64, bx_usize};
use crate::bmo_abi::handle::opaque::BmoHandle;
...
pub trait BmoRead {
    fn read(&mut self, buf: &mut [u8]) -> Result<bx_usize, crate::bmo_abi::fundamentals::error::BmoError>;
}

pub trait BmoWrite {
    fn write(&mut self, buf: &[u8]) -> Result<bx_usize, crate::bmo_abi::fundamentals::error::BmoError>;
    fn flush(&mut self) -> Result<(), crate::bmo_abi::fundamentals::error::BmoError>;
}

pub trait BmoSeek {
    fn seek(&mut self, offset: bx_u64, mode: BmoSeekMode) -> Result<bx_u64, crate::bmo_abi::fundamentals::error::BmoError>;
}
