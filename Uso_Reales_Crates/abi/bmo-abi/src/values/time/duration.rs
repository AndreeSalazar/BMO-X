...
impl BmoDuration {
    ...
    #[inline(always)]
    pub const fn from_us(us: bx_u64) -> Self {
        Self {
    ...
    #[inline(always)]
    pub const fn from_ms(ms: bx_u64) -> Self {
        Self {
    ...
    #[inline(always)]
    pub const fn from_secs(s: bx_u64) -> Self {
        Self {
    ...
    #[inline(always)]
    pub const fn as_ns(self) -> bx_u64 {
        self.ns
    }

    #[inline(always)]
    pub const fn as_us(self) -> bx_u64 {
        self.ns / 1_000
    }

    #[inline(always)]
    pub const fn as_ms(self) -> bx_u64 {
        self.ns / 1_000_000
    }

    #[inline(always)]
    pub const fn as_secs(self) -> bx_u64 {
    ...
    pub const fn mul_u32(self, factor: u32) -> Self {
        Self {
            ns: self.ns.saturating_mul(factor as u64),
        }
    }
}
