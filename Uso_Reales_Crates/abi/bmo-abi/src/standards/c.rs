...
pub static C89: StandardProfile = StandardProfile {
    ...
    features: &[
        ...
        ("const", true),
        ("volatile", true),
        ("string_literals_concat", true),
        ("trigraphs", true),
        ("long_long", false),
        ("inline", false),
        ("restrict", false),
        ("_Bool", false),
        ("compound_literals", false),
    ],
...
pub static C99: StandardProfile = StandardProfile {
    ...
    features: &[
        ...
        ("flexible_array_members", true),
        ("mixed_declarations_and_code", true),
        ("line_comments", true),
...
pub static C17: StandardProfile = StandardProfile {
    ...
    short_name: "C17",
    language: "c",
    features: &[("implicit_int", false), ("implicit_function_decl", false)],
...
pub static C23: StandardProfile = StandardProfile {
    ...
    features: &[
        ...
        ("improved_integer_promotions", true),
        ("implicit_int", false),
        ("implicit_function_decl", false),
    ],
