...
pub fn name(nr: u32) -> &'static str {
    match nr {
        0x100 => "wm_create_window",   0x101 => "wm_destroy_window",
        0x102 => "wm_show_window",     0x103 => "wm_hide_window",
        0x104 => "wm_set_title",       0x105 => "wm_get_bounds",
        0x106 => "wm_set_bounds",      0x107 => "wm_begin_paint",
        0x108 => "wm_end_paint",       0x109 => "wm_push_clip",
        0x10A => "wm_pop_clip",        0x10B => "wm_set_focus",
        0x10C => "wm_get_focus",       0x10D => "wm_register_class",
        0x10E => "wm_pump_events",     0x10F => "wm_translate_message",
        0x110 => "draw_clear",         0x111 => "draw_pixel",
        0x112 => "draw_line",          0x113 => "draw_rect",
        0x114 => "draw_circle",        0x115 => "draw_text",
        0x116 => "draw_blit",          0x117 => "draw_gradient_v",
        0x118 => "draw_gradient_h",    0x119 => "draw_rounded_rect",
        0x120 => "winpaint_fill_rect", 0x121 => "winpaint_draw_text",
        0x122 => "winpaint_draw_pixel",0x123 => "winpaint_draw_line",
        0x124 => "winpaint_draw_blit", 0x125 => "winpaint_draw_circle",
        0x130 => "compositor_begin_frame", 0x131 => "compositor_end_frame",
        0x132 => "compositor_present", 0x133 => "compositor_set_target",
        0x134 => "compositor_flush",
        0x140 => "fs_open",            0x141 => "fs_close",
        0x142 => "fs_read",            0x143 => "fs_write",
        0x144 => "fs_seek",            0x145 => "fs_stat",
        0x146 => "fs_mkdir",           0x147 => "fs_readdir",
        0x148 => "fs_delete",          0x149 => "fs_mount",
        0x150 => "time_now_ns",        0x151 => "time_now_us",
        0x152 => "time_sleep_ns",      0x153 => "time_sleep_ms",
        0x160 => "poll_key",           0x161 => "poll_mouse",
        0x162 => "poll_event",
        0x170 => "audio_play",         0x171 => "audio_stop",
        0x172 => "audio_beep",         0x173 => "audio_load_wave",
        0x180 => "proc_spawn",         0x181 => "proc_exit",
        0x182 => "proc_get_pid",       0x183 => "proc_get_tid",
        0x184 => "proc_yield",         0x185 => "thread_create",
        0x186 => "thread_exit",        0x187 => "thread_join",
        0x188 => "thread_self",
        0x190 => "mem_alloc",          0x191 => "mem_free",
        0x192 => "mem_map",            0x193 => "mem_unmap",
        0x194 => "befcore_send",       0x195 => "befcore_recv",
        0x196 => "befcore_poll",       0x197 => "befcore_register",
        0x1A0 => "ipc_port_create",    0x1A1 => "ipc_port_send",
        0x1A2 => "ipc_port_recv",      0x1A3 => "ipc_port_close",
        0x1C0 => "surface_map",        0x1C1 => "surface_unmap",
        0x1C2 => "surface_present",
        0x1F0 => "debug_print",        0x1F1 => "debug_trace",
        0x1F2 => "debug_assert",       0x1F3 => "debug_panic",
