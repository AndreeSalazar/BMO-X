...
/// Launch a simple BEF app process (hello world ring3 test).
pub fn launch_bef_app() {
    crate::cabina::info("desktop", "launching BEF app process");
    crate::dev::console::serial_write("[desktop] launching BEF hello app...\n");

    // Build and spawn a minimal ELF hello world binary
    // (devours through the BEF pipeline into a real Ring 3 process)
