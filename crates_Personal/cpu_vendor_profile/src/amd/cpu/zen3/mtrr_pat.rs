...
pub fn init_mtrr(vram_base: u64, vram_size: u64) -> bool {
    ...
    crate::serial_write("[mtrr] configured");
    if vram_size > 0 {
        crate::serial_write(" (VRAM @ 0x");
        crate::serial_write_u64(vram_base, 16);
        crate::serial_write(" = WC)");
    }
    crate::serial_write("\n");
    true
}
...
pub fn init_pat() -> bool {
    ...
    crate::serial_write("[pat] configured (entry 4 = WC)\n");
    true
}
...
pub fn init(vram_base: u64, vram_size: u64) -> bool {
    crate::serial_write("[mtrr] skipped (BIOS may lock MTRRs)\n");
    crate::serial_write("[pat] skipped (WB default OK)\n");
