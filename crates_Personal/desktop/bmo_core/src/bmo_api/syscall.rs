...
fn sys_mem_alloc(size: u64) -> u64 {
    ...
    let p = crate::mm::heap::heap_alloc(size as usize, 8);
...
fn sys_mem_free(ptr: u64, size: u64) -> u64 {
    ...
    crate::mm::heap::heap_free(ptr as *mut u8, size as usize, 8);
    err::OK
}
...
fn sys_fs_open(name_ptr: u64, name_len: u64) -> u64 {
    ...
    crate::fs::ramdisk::open(name_ptr, name_len)
}

/// NR_FS_CLOSE: cierra un fd.
fn sys_fs_close(fd: u64) -> u64 {
    crate::fs::ramdisk::close(fd)
}
...
fn sys_audio_beep(freq: u64, ms: u64) -> u64 {
    ...
    crate::desktop::beep(freq as u32, ms as u32);
    err::OK
}
...
fn sys_compositor_present() -> u64 {
    crate::bmo_api::paint_compositor::tick();
    err::OK
}
