...
pub fn init(rsdp_hint: Option<u64>) -> Result<&'static str, AcpiError> {
    ...
    crate::serial_write("[acpi] RSDP @ 0x");
    crate::serial_write_u64(rsdp_addr, 16);
    crate::serial_write(", rev=");
    let rev: u8 = rsdp.revision;
    crate::serial_write_u64(rev as u64, 10);
    crate::serial_write(", XSDT @ 0x");
    let xsdt_addr = rsdp.sdt_addr();
    crate::serial_write_u64(xsdt_addr, 16);
    crate::serial_write(" len=");
    let len: u32 = xsdt.length;
    crate::serial_write_u64(len as u64, 10);
    crate::serial_write(" — ");
    crate::serial_write(mcfg_status);
    crate::serial_write("\n");
