...
pub use controller::{AhciController, PortState, AhciPort, DiskError, read_sectors_phys, write_sectors_phys, identify_phys, probe, init_port_dma, controller, reset_ctrl, SIG_SATA_DISK, SECTOR};
