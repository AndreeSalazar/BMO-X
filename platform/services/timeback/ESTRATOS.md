...
**Estado**: diseño. Nada implementado. Este documento existe para que el
formato se decida ANTES de tocar un sector — en un sistema de ficheros,
equivocarse cuesta datos.
