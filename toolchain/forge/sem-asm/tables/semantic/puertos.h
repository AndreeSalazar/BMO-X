 ...
 * E/S. A un puerto no se llega con un puntero — no hay dirección que
 ...
 * PIC (0x20/0xA0), la configuración de PCI (0xCF8/0xCFC). Lo moderno —xHCI,
...
/* `out dx, eax` — cuatro. Es el que usa la configuración de PCI. */
