...
SA400S37480G SATA · 1920×1080 UEFI GOP.
...
**`19.99 × 3 = 59.97`, and `59.97 − 19.99 = 39.98`.** Exact, in integer scale,
...
52 WARN  fb: el dueño de la pantalla MURIO: se vuelve al panel del kernel
